...
class Knobs:
    ...
    grasp_hold_steps: int = 8       # GRASP: steps to hold closing before LIFT
    ...
    use_aik: int = 0               # 1 => use the ANALYTIC level-gripper IK
    ...
    up_bias: float = 0.04           # PLACE/HOLD: command the box this far ABOVE target
